    ...
    >
      <template #header="{ collapsed }">
        <NuxtLink
          v-if="!collapsed"
          to="/"
          class="flex items-center gap-1.5 outline-primary/25 focus-visible:outline-3 rounded-md"
        >
          <UIcon name="i-lucide-bot" class="h-6 w-6 text-primary-500 shrink-0" />
          <span class="text-lg font-bold text-highlighted">Chess Coach</span>
        </NuxtLink>
